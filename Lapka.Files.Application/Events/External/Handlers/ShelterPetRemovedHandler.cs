...
namespace Lapka.Files.Application.Events.External.Handlers
{
    public class ShelterPetRemovedHandler : IEventHandler<ShelterPetRemoved>
    {
        ...
        public ShelterPetRemovedHandler(IMinioServiceClient minioServiceClient, IPhotoRepository photoRepository,
        ...
        {
            IEnumerable<string> paths = await _grpcPetPhotoService.GetShelterPetPhotosAsync(@event.Id);
