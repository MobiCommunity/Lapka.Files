...
{
    public class ShelterPetPhotosRemovedHandler : IEventHandler<ShelterPetPhotosRemoved>
    {
        private readonly IMinioServiceClient _minioServiceClient;
        private readonly IPhotoRepository _photoRepository;

        public ShelterPetPhotosRemovedHandler(IMinioServiceClient minioServiceClient, IPhotoRepository photoRepository)
        {
            _minioServiceClient = minioServiceClient;
            _photoRepository = photoRepository;
        }
        public async Task HandleAsync(ShelterPetPhotosRemoved @event)
        {
